...
class MainWindow(QMainWindow):
    ...
    def _init_ui(self):
        # We need a scroll area to allow scrolling on smaller screens
        ...
        center_widget.setMaximumWidth(1600)
        
        self.main_layout = QVBoxLayout(center_widget)
        self.main_layout.setContentsMargins(32, 24, 32, 40)
        self.main_layout.setSpacing(20)
        
        wrapper_layout = QHBoxLayout()
        wrapper_layout.addStretch()
        wrapper_layout.addWidget(center_widget, stretch=1)
        wrapper_layout.addStretch()
        
        outer_layout.addLayout(wrapper_layout)
    ...
    def _create_filter_bar(self):
        ...
        for label, items, stretch in filters:
            ...
            vbox.setSpacing(6)
            lbl = QLabel(label)
            lbl.setStyleSheet("color: #6B7280; font-size: 11px; font-weight: 500;")
            cb = QComboBox()
            cb.addItems(items)
    ...
    def _create_playback_controls(self):
        playback_card = QWidget()
        playback_card.setProperty("class", "Card")
        layout = QHBoxLayout(playback_card)
        layout.setContentsMargins(16, 12, 16, 12)
        layout.setSpacing(16)
        ...
        speed_lbl.setStyleSheet("color: #6B7280; font-size: 11px; font-weight: 500;")
        ...
        overlay_lbl.setStyleSheet("color: #6B7280; font-size: 11px; font-weight: 500;")
        ...
        self.main_layout.addWidget(playback_card)
    ...
    def update_overlays(self):
        ...
        d = False # self.chk_det.isChecked() - removed detection overlay for cleaner look
